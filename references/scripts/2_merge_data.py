...
if __name__ == "__main__":
    # ディレクトリパスを指定
    b_files_dir = "/Users/yoshidont_mind/Library/Mobile Documents/com~apple~CloudDocs/Desktop/CST term4/COMP 4949 Big Data Analytics Methods/boat_race_prediction/data/schedules"  # Bファイルが格納されているディレクトリ
    k_files_dir = "/Users/yoshidont_mind/Library/Mobile Documents/com~apple~CloudDocs/Desktop/CST term4/COMP 4949 Big Data Analytics Methods/boat_race_prediction/data/results"    # Kファイルが格納されているディレクトリ
    
    # 出力ファイル名テンプレートを設定（{date}は最新日付に置換される）
    output_file_template = "/Users/yoshidont_mind/Library/Mobile Documents/com~apple~CloudDocs/Desktop/CST term4/COMP 4949 Big Data Analytics Methods/boat_race_prediction/data/merged/merged_{date}.csv"
    
    # カレントディレクトリにdata/schedulesとdata/resultsがない場合は、
    # 絶対パスで指定されたディレクトリを使用
    if not os.path.exists(b_files_dir):
        b_files_dir = "/Users/yoshidont_mind/Library/Mobile Documents/com~apple~CloudDocs/Desktop/CST term4/COMP 4949 Big Data Analytics Methods/boat_race_prediction/data/schedules"
    if not os.path.exists(k_files_dir):
        k_files_dir = "/Users/yoshidont_mind/Library/Mobile Documents/com~apple~CloudDocs/Desktop/CST term4/COMP 4949 Big Data Analytics Methods/boat_race_prediction/data/results"
